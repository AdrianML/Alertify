...
public class LoginActiv extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptCreateUser() {
        ...
        if (cancel) {
            ...
            mAuth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(LoginActiv.this, new OnCompleteListener<AuthResult>() {
                        @Override
            ...
            mAuth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(LoginActiv.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                // Sign in success
                                tinyDB.putString("path", email.replace(".", ""));
                                mEditor.putBoolean("loginsuccesful", true).commit();
                                Intent intInicio = new Intent(getBaseContext(), InicioActiv.class);
                                startActivity(intInicio);
                                ...
                                // If sign in fails, display a message to the user.
                                Log.i("ERROR FIREBASE", String.valueOf(task.isSuccessful()));
                                showProgress(false);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(final String mEmail, final String mPassword) {
            this.email = mEmail;
